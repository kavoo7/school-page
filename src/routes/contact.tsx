...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Get in touch with Jupiter Academy admissions, faculty or the front office.",
      },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <p className="mt-3 max-w-xl text-muted-foreground">
          We love hearing from prospective families, alumni and our neighbours. Pick whichever works
          best for you.
        </p>
        ...
        <div className="mt-12 grid gap-10 md:grid-cols-[1fr_1.2fr]">
          <ul className="space-y-5 text-sm">
            <li className="flex gap-3">
              ...
              <span>
                <b className="text-primary">Campus</b>
                <br />
                12 Orbit Lane, Springfield, 64801
              </span>
            </li>
            <li className="flex gap-3">
            ...
            {sent ? (
              <div className="py-10 text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  We'll be in touch within two school days.
                </p>
              </div>
            ) : (
